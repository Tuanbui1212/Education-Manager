...
const Combobox: React.FC<ComboboxProps> = ({
    ...
    return (
        <div className="flex flex-col gap-1 w-full relative" ref={wrapperRef}>
            ...
            {isOpen && (
                <div className="absolute top-[calc(100%+8px)] left-0 w-full bg-white border border-gray-100 rounded-xl shadow-2xl z-50 max-h-60 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200 custom-scrollbar">
                    {results.length > 0 ? (
