...
const GlobalLoading = ({ text = 'Đang tải dữ liệu...', overlay = true }: { text?: string; overlay?: boolean }) => {
  return (
    <div
      className={`z-[9999] bg-black/40 backdrop-blur-sm flex justify-center items-center ${
        overlay ? 'fixed inset-0' : 'absolute inset-0 rounded-2xl'
      }`}
    >
