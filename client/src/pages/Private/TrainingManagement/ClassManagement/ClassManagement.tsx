...
const ClassManagement = () => {
    ...
    const openStudentModal = (classData: IClass) => {
        if (classData._id) {
            setClassForStudents({ id: classData._id, name: classData.name });
    ...
    const getStatusLabel = (status: ClassStatus) => {
        switch (status) {
            case ClassStatus.ACTIVE: return { label: 'Hoạt động', class: 'bg-green-100 text-green-700' };
            case ClassStatus.MAINTENANCE: return { label: 'Bảo trì', class: 'bg-yellow-100 text-yellow-700' };
            case ClassStatus.INACTIVE: return { label: 'Ngừng hoạt động', class: 'bg-red-100 text-red-700' };
    ...
    return (
        <div className="p-8 w-full animate-in fade-in duration-500">
            ...
            <div className="flex flex-wrap justify-between items-center mb-8 gap-4">
                    ...
                    <div className="relative inline-block">
                        ...
                        {openFilter && (
                            <div className="absolute mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                ...
                                {Object.values(ClassStatus).map((item) => (
                                    <div
                                        key={item}
                                        onClick={() => {
                ...
                <Button variant="primary" icon={<Plus size={20} />} onClick={() => setShowClassModal(true)} className="rounded-xl shadow-lg shadow-primary/20">
                    Tạo lớp học mới
                </Button>
            </div>
                                        ...
                                        >
                                            ...
                                            <td className="p-5">
                                                <div className="flex items-center gap-2 text-gray-600">
                                                    ...
                                                    <span className="font-medium">{typeof item.teacherId === 'object' ? item.teacherId.fullName : item.teacherId}</span>
                                                </div>
                                            </td>
                                ...
                                <tr>
                                    <td colSpan={7} className="p-20 text-center text-gray-400">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <p className="text-xl font-medium italic">Không tìm thấy lớp học nào khớp với điều kiện tìm kiếm</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
