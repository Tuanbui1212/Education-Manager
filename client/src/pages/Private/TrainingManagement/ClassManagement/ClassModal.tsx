  ...
  return (
    <div className="fixed inset-0 z-120 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl z-10 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form
          className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 max-h-[85vh] overflow-y-auto custom-scrollbar"
        ...
        >
          <div className="space-y-6 md:col-span-1">
            ...
            >
              ...
              <option value={ClassStatus.COMPLETED}>Đã hoàn thành</option>
              <option value={ClassStatus.PENDING}>Sắp khai giảng</option>
            </SelectField>
          </div>
              ...
              <div className="flex-1 overflow-y-auto min-h-[150px] max-h-[300px] space-y-2 pr-2 custom-scrollbar">
                {selectedStudents.length > 0 ? (
                  selectedStudents.map((student) => (
                    <div
                      key={student._id}
                      className="flex justify-between items-center bg-white p-3 rounded-xl border border-gray-200 group hover:border-primary/50 transition-all shadow-sm"
                    >
