          ...
          return (
            <div key={index} className="border border-gray-100 rounded-xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-5 py-3 bg-gray-50 border-b border-gray-100">
                ...
                <span
                  className={`text-xs font-semibold px-2 py-0.5 rounded-full ${allGranted
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-2.5">
                {moduleGroup.permissions.map((permission) => {
                  ...
                  return (
                    <div
                      key={permission.code}
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg border transition-colors ${isGranted ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-100 opacity-60'
                        }`}
                    >
                      {isGranted ? (
