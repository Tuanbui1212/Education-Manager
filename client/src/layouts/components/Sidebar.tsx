...
const menuConfig = [
  {
    ...
    permission: [PERMISSIONS.USER.VIEW, PERMISSIONS.ROLE.VIEW],
    subItems: [
  ...
  },
  {
    ...
    permission: [PERMISSIONS.USER.VIEW, PERMISSIONS.TEACHER.VIEW, PERMISSIONS.STAFF.VIEW],
    subItems: [
  ...
  },
  {
    ...
    permission: [PERMISSIONS.CLASS.VIEW, PERMISSIONS.STUDENT.VIEW, PERMISSIONS.COURSE.VIEW, PERMISSIONS.SCHEDULE.VIEW],
    subItems: [
      { label: 'Quản lý học viên', path: PATHS.TRAINING_STUDENT, permission: PERMISSIONS.STUDENT.VIEW },
      {
      ...
      { label: 'Quản lý lớp học', path: PATHS.TRAINING_CLASSES, permission: PERMISSIONS.CLASS.VIEW },
      {
        ...
        permission: PERMISSIONS.SCHEDULE.VIEW || PERMISSIONS.CLASS.VIEW,
      },
