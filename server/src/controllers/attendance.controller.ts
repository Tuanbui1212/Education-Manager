...
export class AttendanceController {
    ...
    getAllClassesByTeacherId = async (req: Request, res: Response) => {
        try {
            const result = await this.attendanceService.getAllClassesByTeacherId(req.query, (req as any).user?.id);
